...
/**
 * The controller for the AddProduct view.
 *
 * @author Alex
 */
public class AddProductController implements Initializable {
     ...
     * The bottom table is configured for associated parts.
     *
     * @param url
    ...
    /**
     * Adds the new product and any associated parts to the inventory.
     * Called when the user clicks the save button.
     * Validates input and provides errors if necessary, otherwise create the new product and add to the inventory.
     * If product is successfully added to the inventory, return to the MainScreen view.
     *
     * @param actionEvent
     * @throws IOException
     */
    public void saveProduct(ActionEvent actionEvent) throws IOException {
        if (DialogHandler.confirm("Add Product", "Do you want to add the new product?")) {
            String error = "";
            errorText.setText("");
    ...
    public void cancel(ActionEvent actionEvent) throws IOException {
        if (DialogHandler.confirm("Add Product", "Do you want to cancel adding a product?")) {
            Parent parent = FXMLLoader.load(getClass().getResource("/view/MainScreen.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
            stage.setScene(scene);
